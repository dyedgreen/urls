...
const ICON_NOTICE = <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function Notice({ type = "notice", message, style }) {
